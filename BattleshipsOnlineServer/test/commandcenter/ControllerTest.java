...
public class ControllerTest {
    ...
    public void testExLoadGameWithValidInputOutput() {
        ...
        final String INDENT = "\t\t\t\t\t";
        final String EXPECTED_OUTPUT = NL + INDENT + YOUR_BOARD_BANNER + NL +
                INDENT + NUMBERS + NL +
                ...
                INDENT + "J |_|_|_|_|_|_|_|_|_|_|" + NL + NL +
                "  Legend:" + NL +
                "  * - ship field" + NL +
                "  X - hit ship field" + NL +
                ...
                "                         Possible actions" + NL+
                "*****************************************************************" + NL+
                "      place-ship [ship-type] from to {[ship-type] from to .... }" + NL +
                "_________________________________________________________________" + NL +
                "          [ship-type] | length | #" + NL +
                "          destroyer   |     2  | 2" + NL +
                "          submarine   |     3  | 3" + NL +
                "          battleship  |     4  | 2" + NL +
