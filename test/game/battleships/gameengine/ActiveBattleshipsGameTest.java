...
public class ActiveBattleshipsGameTest {
    ...
    public void testToStringWithNewGameTwoPlayers() {
        final String EXPECTED = NL +
                TAB + YOUR_BOARD_BANNER + NL +
                TAB + NUMBERS + NL +
                TAB + TOP_OF_BOARD + NL +
                EMPTY_BOARD +
                NL + NL +
                TAB + ENEMY_BOARD_BANNER + NL +
                TAB + NUMBERS + NL +
                TAB + TOP_OF_BOARD + NL +
                EMPTY_BOARD +
                NL + LEGEND;
    ...
    public void testToStringWithPlaceValidShipsOnValidFields() {
        ...
        final String EXPECTED = NL +
                ...
                TAB + "G |*|_|_|_|_|_|_|_|_|_|" + NL +
                TAB + "H |*|_|_|_|_|_|_|_|_|_|" + NL +
                TAB + "I |_|_|_|_|_|_|_|_|_|_|" + NL +
                TAB + "J |_|_|_|_|_|_|_|_|_|_|" + NL +
                NL + NL +
                TAB + ENEMY_BOARD_BANNER + NL +
